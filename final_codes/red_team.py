...
if TRAINING:
    ...
    print 'Loading model...' 
    #with open('LearnedParamsL1_0.model','rb') as fp:
...
for l in l1coef:
    for j in l2coef:
        ...
        if TRAINING:
            ...
            for k in range(5):
                ...
                #with open('LearnedParamsL1_0.model','wb') as fp:
	...
	for EPS in eps_values:
	   ...
	   # Find accuracy of the classifier on the test set and adversarial set
	    ...
	    #count_attack = 0
	    #for i in range(5):     
	       #plot_mnist_digit(teX[i], adX[i], 'test_img00_{}_{}.jpg'.format(i,eps),'less_ad_img00_{}_{}.jpg'.format(i,eps))
